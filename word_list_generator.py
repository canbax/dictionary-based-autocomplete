...
'dictionary sources/maidis/kelime_listesi.txt', 'dictionary sources/zargan/word_forms_stems_and_frequencies_full.txt', 
'dictionary sources/excelgurusu/tdk-imla.txt', 'dictionary sources/cannuhlar/turkce_kelime_listesi.txt',]
...
word_set2 = parse_source(get_first_word_from_line, file_names[2])
word_set3 = parse_source(get_second_word_from_line, file_names[3])
word_set4 = parse_source(get_first_word_from_line, file_names[4])
word_set5 = parse_source(get_first_word_from_line, file_names[5])

all_sets = word_set1.union(word_set0).union(word_set2).union(word_set3).union(word_set4).union(word_set5)
